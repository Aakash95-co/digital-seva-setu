...
from app import app
from tabs import metadata, monthly_trends, tabular, treemap, advanced_analytics, findings, oot_drilldown, report_tracking, insights
...
app.layout = html.Div([
    ...
    dcc.Tabs(id="main-tabs", value="metadata-tab", children=[
        ...
        dcc.Tab(label="📁 Report & Tracking", value="report-tracking-tab", children=[report_tracking.layout]),        dcc.Tab(label="🎯 Insights & Action Centre", value="insights-tab", children=[insights.layout]),    ])
])
